...
| `/phieng-loi` | Playful culture chapter | Lazy Canvas 2D route with no game engine. |
...
- Leaving 1954 destroys WebGL resources and audio. Leaving Phiêng Lơi cancels its animation frame and removes keyboard/blur listeners.
