...
const CHAPTER_INTRO_OVERRIDES: Record<string, BookLocalizedText> = {
  ...
  'chapter-08-nhung-ngon-doi': {
    vi: 'Những ngọn đồi đi vào đường sá, ánh sáng, tầm nhìn và cách người Điện Biên cảm nhận khoảng cách. Đời sống lớn lên bên chân chúng, ngày ngày vòng qua những mốc im lặng ấy.',
    en: 'The hills enter the roads, the light, the view, and the way people in Dien Bien feel distance. Life has grown at their feet, circling those silent landmarks each day.',
  },
...
const PAGE_COPY_OVERRIDES: Record<string, EditorialPageCopy> = {
  ...
  'nhung-ngon-doi': {
    ...
    body: [
      ...
      {
        vi: "Cuối chiều, chúng ta trở lại con đường bê tông nhỏ dưới chân đồi. Ánh sáng dịu đi. Bóng cây kéo dài qua mặt đường. Gió đưa mùi lá và đất xuống giữa những mái nhà. Một lúc lâu chẳng có xe chạy qua. Từ căn nhà gần đó vọng ra tiếng nói chuyện, tiếng bát đũa chạm nhau trong lúc chuẩn bị bữa tối. Trên cao, đường đồi sẫm dần rồi hòa vào đêm. Thành phố tiếp tục việc của người sống; đất âm thầm làm công việc chậm hơn của đất. Sau này nhớ về nơi này, chúng ta có thể quên mình đã đi qua con ngõ nào. Cảm giác bước thật chậm dưới những ngọn đồi thì vẫn còn—giữa một nơi cuộc sống đủ chậm để chúng ta nghe thấy chính mình.",
        en: "Toward evening, we return to the narrow concrete road beneath the hill. The light softens. Tree shadows lengthen across the lane. Wind brings the smell of leaves and earth down among the roofs. For a long while no vehicle passes. From a nearby house come conversation and bowls touching chopsticks as dinner is prepared. Above, the line of the hill darkens into night. The city continues the work of the living; the earth quietly continues the slower work of earth. Later, we may forget which lane we followed. The feeling of walking slowly beneath the hills remains—in a place where life is slow enough for us to hear ourselves.",
      },
      {
